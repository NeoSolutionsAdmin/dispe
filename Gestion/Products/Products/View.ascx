...
<div>
<input type="checkbox" id="autovalue" name="autovalue"> Activar calculo valores<br>
</div>
   <div>
...
<script>
    ...
    $('#txtCodigoDeBarra').keypress(function (event) {
        if (event.keyCode == 13) {
            $('#txtNombre').focus();
            event.preventDefault();
        }
    ...
    {
        txtPrecioNeto.val("0");
        txtPorcentajeIVA.val("0");
        txtPrecioCompra.val("0");
        txtPorcentajeGanancia.val("0");
        txtPrecioFinal.val("0");
