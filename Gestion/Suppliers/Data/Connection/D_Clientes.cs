...
namespace Data2.Connection
{
    public class D_Clientes
    {
        ...
        public DataTable Get_MovimientosCliente(int IdCliente) 
        {
            GestionDataSet.Select_MovimientoCCByIdClientDataTable DT = new GestionDataSet.Select_MovimientoCCByIdClientDataTable();
            GestionDataSetTableAdapters.Select_MovimientoCCByIdClientTableAdapter TA = new GestionDataSetTableAdapters.Select_MovimientoCCByIdClientTableAdapter();
            TA.Fill(DT, IdCliente);
            if (DT.Rows.Count > 0)
            {
                return DT;
            }
